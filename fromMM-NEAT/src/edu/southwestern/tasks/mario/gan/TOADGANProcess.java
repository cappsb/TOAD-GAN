...
public class TOADGANProcess extends Comm {
	...
	public static final String PYTHON_BASE_PATH = "..\\" ;
	public static final String TOADGAN_PATH = PYTHON_BASE_PATH + "generate_toad.py";
...
//	public static final int MEGA_MAN_OUT_HEIGHT = 14;
	...
	private static TOADGANProcess ganProcess = null;
	 ...
	 */
	public static TOADGANProcess getGANProcess() {
...
//				break;
			case LODE_RUNNER:
//				ganProcess = new TOADGANProcess(PYTHON_BASE_PATH+"LodeRunnerGAN"+ File.separator + Parameters.parameters.stringParameter("LodeRunnerGANModel"), 
//						Parameters.parameters.integerParameter("GANInputSize"), 
...
//						LODE_RUNNER_OUT_WIDTH, LODE_RUNNER_OUT_HEIGHT);
				ganProcess = new TOADGANProcess(TOADGAN_PATH + "--out_ output/wandb/test4Maybe/files/ --input-dir input/megaman/experimental/ --input-name test5.txt --num_layer 3 --alpha 100 --niter 4000 --nfc 64 --game megaman");
				break;
			case MEGA_MAN:
				ganProcess = new TOADGANProcess(TOADGAN_PATH + "--out_ output/wandb/test4Maybe/files/ --input-dir input/megaman/experimental/ --input-name test5.txt --num_layer 3 --alpha 100 --niter 4000 --nfc 64 --game megaman");
				break;
...
//	}
	 ...
	 */
	public TOADGANProcess(String GANPath) {
		super();
...
//		this.height = height;
	...
	public void launchGAN() {
		...
		ProcessBuilder builder = new ProcessBuilder(PythonUtil.PYTHON_EXECUTABLE, TOADGAN_PATH, this.GANPath);
